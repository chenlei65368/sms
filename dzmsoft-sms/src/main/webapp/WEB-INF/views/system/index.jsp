...
<script type="text/javascript"
	src="http://api.map.baidu.com/api?v=2.0&ak=nscg08dISxIt0SuXv2pzBOSetMwzXWb1"></script>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',border:false" style="height:52px;">
		<div id="topbar" class="top-bar">
        	<div class="top-bar-left">
               <h1 style="margin-left: 10px; margin-top: 10px;color: #fff">SMS<span style="color: #3F4752">供应商运营管理系统</span></h1>
           	</div>
