...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="smsCleanBagLine:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="smsCleanBagLine:add">
	       			...
	       			<shiro:hasPermission name="smsCleanBagLine:edit">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/smsCleanBagLineList.js"></script>
</body>
</html>