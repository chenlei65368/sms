...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="smsHouseBuilding:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="smsHouseBuilding:add">
	       			...
	       			<shiro:hasPermission name="smsHouseBuilding:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsHouseBuilding:remove">
						...
						<td>
	       				<span class="toolbar-item dialog-tool-separator"></span>
	       				       			...
	       				       			<shiro:hasPermission name="smsHouseBuilding:enable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsHouseBuilding:disable">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/smsHouseBuildingList.js"></script>
</body>
</html>