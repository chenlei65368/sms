...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="smsHouseholdPriceRule:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="smsHouseholdPriceRule:add">
						<td>
	       			...
	       			<shiro:hasPermission name="smsHouseholdPriceRule:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsHouseholdPriceRule:remove">
	       				<td>
						...
						<td>
	       				<span class="toolbar-item dialog-tool-separator"></span>
	       				       			...
	       				       			<shiro:hasPermission name="smsHouseholdPriceRule:enable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsHouseholdPriceRule:disable">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/smsHouseholdPriceRuleList.js"></script>
</body>
</html>