...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="smsPersonRequireLine:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="smsPersonRequireLine:add">
	       			...
	       			<shiro:hasPermission name="smsPersonRequireLine:edit">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/smsPersonRequireLineList.js"></script>
</body>
</html>