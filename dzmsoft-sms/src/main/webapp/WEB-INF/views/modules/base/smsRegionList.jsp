...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="smsRegion:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="smsRegion:add">
						<td>
	       			...
	       			<shiro:hasPermission name="smsRegion:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsRegion:remove">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/smsRegionList.js"></script>
</body>
</html>