...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="smsMallBrand:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="smsMallBrand:add">
						<td>
	       			...
	       			<shiro:hasPermission name="smsMallBrand:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsMallBrand:remove">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/smsMallBrandList.js"></script>
</body>
</html>