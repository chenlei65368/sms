...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				<input type="text" name="filter_likes_name" class="easyui-textbox" data-options="width:150,prompt: '清洁包名称'"/>
				<shiro:hasPermission name="smsCleanBag:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="smsCleanBag:add">
						<td>
	       			...
	       			<shiro:hasPermission name="smsCleanBag:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsCleanBag:remove">
	       				<td>
						...
						<td>
	       				<span class="toolbar-item dialog-tool-separator"></span>
	       				       			...
	       				       			<shiro:hasPermission name="smsCleanBag:enable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsCleanBag:disable">
	       				<td>
						<a href="javascript:void(0)" class="easyui-linkbutton disable" iconCls="icon-no" plain="true">设置运营区域</a>
						</td>
						<td>
	       				<span class="toolbar-item dialog-tool-separator"></span>
	       				</td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/smsCleanBagList.js"></script>
</body>
</html>