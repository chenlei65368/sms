...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="smsNewhomePriceRule:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="smsNewhomePriceRule:add">
						<td>
	       			...
	       			<shiro:hasPermission name="smsNewhomePriceRule:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsNewhomePriceRule:remove">
	       				<td>
						...
						<td>
	       				<span class="toolbar-item dialog-tool-separator"></span>
	       				       			...
	       				       			<shiro:hasPermission name="smsNewhomePriceRule:enable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsNewhomePriceRule:disable">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/smsNewhomePriceRuleList.js"></script>
</body>
</html>