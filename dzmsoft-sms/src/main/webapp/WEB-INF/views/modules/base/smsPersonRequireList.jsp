...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				<input type="text" name="filter_likes_name" class="easyui-textbox" data-options="width:150,prompt: '需求名称'"/>
				<shiro:hasPermission name="smsPersonRequire:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="smsPersonRequire:add">
						<td>
	       			...
	       			<shiro:hasPermission name="smsPersonRequire:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsPersonRequire:remove">
	       				<td>
						...
						<td>
	       				<span class="toolbar-item dialog-tool-separator"></span>
	       				       			...
	       				       			<shiro:hasPermission name="smsPersonRequire:enable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="smsPersonRequire:disable">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/smsPersonRequireList.js"></script>
</body>
</html>